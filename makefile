...
LOGIC_SOURCE = logic/acceleration.c logic/alarm.c logic/altitude.c logic/battery.c  logic/clock.c logic/cw.c logic/date.c logic/menu.c logic/rfbsl.c logic/rfsimpliciti.c logic/stopwatch.c logic/temperature.c logic/test.c logic/user.c logic/phase_clock.c logic/eggtimer.c logic/prout.c logic/vario.c logic/sidereal.c logic/strength.c logic/sequence.c logic/gps.c logic/tiltset.c

LOGIC_O = $(addsuffix .o,$(basename $(LOGIC_SOURCE)))

DRIVER_SOURCE =  driver/adc12.c driver/buzzer.c driver/display.c driver/display1.c driver/pmm.c driver/ports.c driver/radio.c driver/rf1a.c driver/rtc.c driver/timer.c  driver/vti_as.c driver/vti_ps.c driver/dsp.c driver/infomem.c
